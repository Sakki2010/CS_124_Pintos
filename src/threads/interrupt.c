...
/* Interrupt handlers. */
void intr_handler(intr_frame_t *args);
static void unexpected_interrupt(const intr_frame_t *);
...
static void unexpected_interrupt(const intr_frame_t *f) {
...
void intr_dump_frame(const intr_frame_t *f) {
    uint32_t cr2;
