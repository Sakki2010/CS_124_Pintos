...
struct intq
  {
    /* Waiting threads. */
    lock_t lock;           /* Only one thread may wait at once. */
    thread_t *not_full;    /* Thread waiting for not-full condition. */
    thread_t *not_empty;   /* Thread waiting for not-empty condition. */
